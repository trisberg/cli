...
const (
	...
	BindingRefFlagName            = "--binding-ref"
	...
	PasswordKeyFlagName           = "--password-key"
	PortFlagName                  = "--port"
	PortKeyFlagName               = "--port-key"
	ProviderFlagName              = "--provider"
	RegistryFlagName              = "--registry"
	RegistryUserFlagName          = "--registry-user"
	SecretRefFlagName             = "--secret-ref"
	...
	UsernameKeyFlagName           = "--username-key"
	URIFlagName                   = "--uri"
	URIKeyFlagName                = "--uri-key"
